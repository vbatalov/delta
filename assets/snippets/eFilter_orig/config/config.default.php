...
//слайдер
$tplRowSlider = '<div class="slider_text slider_text[+tv_id+]"><label for="minCostInp[+tv_id+]"><span>от</span><input type="text" id="minCostInp[+tv_id+]" name="f[[+tv_id+]][min]" value="[+minval+]" data-min-val="[+minvalcurr+]" placeholder="[+minvalcurr+]"></label> <label for="maxCostInp[+tv_id+]"><span>до</span><input type="text" id="maxCostInp[+tv_id+]" name="f[[+tv_id+]][max]" value="[+maxval+]" data-max-val="[+maxvalcurr+]" placeholder="[+maxvalcurr+]"></label></div>';
$tplOuterSlider = '
	<div class="fltr_block fltr_block_slider fltr_block[+tv_id+] [+active_block_class+]">
		...
		<div class="slider_text slider_text[+tv_id+]" style="display:none;">от <span id="minCost[+tv_id+]"></span> до <span id="maxCost[+tv_id+]"></span></div>
